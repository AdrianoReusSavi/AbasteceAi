    ...
    <Tab.Navigator tabBar={(props) => <BottomTabBar {...props} />}>
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: "map", // Adicione o ícone apropriado aqui
        }}
      />
      <Tab.Screen
        name="Distance"
        ...
        options={{
          tabBarLabel: "Distância",
          headerTitle: (props) => <Header {...props} />,
          tabBarIcon: "ruler", // Adicione o ícone apropriado aqui
        }}
      />
      <Tab.Screen
        name="History"
        ...
        options={{
          ...
          headerTitle: (props) => <Header {...props} />,
          tabBarIcon: "history", // Adicione o ícone apropriado aqui
        }}
      />
      <Tab.Screen
        name="Settings"
        ...
        options={{
          ...
          headerTitle: (props) => <Header {...props} />,
          tabBarIcon: "cog", // Adicione o ícone apropriado aqui
        }}
      />
    </Tab.Navigator>
  );
  ...
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen
        ...
        options={{
          title: "GPT Screen",
          headerTitle: (props) => <HeaderGpt {...props} />,
        }}
      />
    </Stack.Navigator>
  );
